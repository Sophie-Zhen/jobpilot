...
- [x] Polish README for portfolio audience — recruiter-readable rewrite reflecting the LLM-powered system (Claude backend, anti-fabrication tailoring, ATS/recruiter eval, referrals, Telegram/Gmail tracker). Done 2026-06-10; GitHub repo description updated to match.
